...
public class rps {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br=new BufferedReader(new FileReader("E:\\Saran Downloads\\Rock_paper_scissor\\src\\test.txt"));
        String st,sk="";
        ...
        while (true) {
            if(Integer.parseInt(b[1])<total){
                BufferedWriter writer = new BufferedWriter(new FileWriter("E:\\Saran Downloads\\Rock_paper_scissor\\src\\test.txt"));
                writer.write(name+" "+total);
                writer.flush();
            }
            BufferedReader br1=new BufferedReader(new FileReader("E:\\Saran Downloads\\Rock_paper_scissor\\src\\test.txt"));
            String st1,sk1="";
